...
const CustomSelect = ({
    ...
    return (
        <div className="relative w-full" ref={selectRef}>
            ...
            {isOpen && (
                <ul
                    className={`absolute z-30 w-full bg-white shadow-lg border rounded-md max-h-60 overflow-y-auto ${
...
const ProductCard = ({ product, onEditClick, onDeleteClick }) => (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 flex flex-col">
        ...
        <div className="p-4 flex flex-col flex-grow">
            ...
            <p className="text-sm text-gray-500 mt-1 h-10 overflow-hidden flex-grow">
                {product.description}
            </p>
...
// Komponen utama halaman Index (Products) - Telah Diperbaiki
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex flex-grow justify-between items-center mb-5">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-colors whitespace-nowrap"
                        >
                            + Add Product
                        </button>
                    </div>
